...
insert into my_user(id, username, password, email, is_active) values ('1', 'user1', 'email1', 'password1', 'email1@email.pl', true);
insert into my_user(id, username, password, email, is_active) values ('2', 'user2', 'email2', 'password2', 'email2@email.pl', true);
